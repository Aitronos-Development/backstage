...
export const shapes: Record<string, string> = {
  glow: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='1368' height='400' fill='none'%3e%3cmask id='a' maskUnits='userSpaceOnUse' x='0' y='0' width='1368' height='400'%3e%3cellipse cx='900' cy='200' rx='600' ry='300' fill='url(%23g)'/%3e%3c/mask%3e%3cg mask='url(%23a)'%3e%3cpath fill='white' d='M0 0h1368v400H0z'/%3e%3c/g%3e%3cdefs%3e%3cradialGradient id='g' cx='50%25' cy='50%25' r='50%25'%3e%3cstop stop-color='white' stop-opacity='0.4'/%3e%3cstop offset='1' stop-color='white' stop-opacity='0'/%3e%3c/radialGradient%3e%3c/defs%3e%3c/svg%3e")`,
...
export const colorVariants: Record<string, string[]> = {
  darkGrey: ['#1E1B4B', '#312E81'],
  marineBlue: ['#1E1B4B', '#3730A3'],
  veryBlue: ['#0C0A1D', '#1E1B4B'],
  rubyRed: ['#4C1D36', '#831843'],
  toastyOrange: ['#431407', '#7C2D12'],
  purpleSky: ['#2E1065', '#5B21B6'],
  eveningSea: ['#1E1B4B', '#7C3AED'],
  teal: ['#1E1B4B', '#4F46E5'],
  pinkSea: ['#500724', '#9D174D'],
  greens: ['#022C22', '#065F46'],
};
...
export function genPageTheme(props: {
  ...
  const backgroundImage = shape ? `${shape},  ${gradient}` : gradient;
...
export const pageTheme: Record<string, PageTheme> = {
  home: genPageTheme({ colors: colorVariants.teal, shape: shapes.glow }),
  ...
  website: genPageTheme({ colors: colorVariants.veryBlue, shape: shapes.glow }),
  library: genPageTheme({ colors: colorVariants.rubyRed, shape: shapes.glow }),
  other: genPageTheme({ colors: colorVariants.darkGrey, shape: shapes.glow }),
  app: genPageTheme({
    colors: colorVariants.toastyOrange,
    shape: shapes.glow,
  }),
  apis: genPageTheme({ colors: colorVariants.eveningSea, shape: shapes.glow }),
  card: genPageTheme({ colors: colorVariants.greens, shape: shapes.glow }),
};
